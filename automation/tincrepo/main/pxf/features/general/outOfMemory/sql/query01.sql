...
-- s/Check the PXF logs located in the.*/Check the PXF logs located in the 'log' directory on host 'mdw' or 'set client_min_messages=DEBUG1' for additional details./
--
-- m/DETAIL/
-- s/DETAIL/CONTEXT/
--
