...
-- s/Illegal file pattern: Unclosed group near index.*/Illegal file pattern: Unclosed group near index xxx/
--
-- m/Unclosed group near index.*/
-- s/Unclosed group near index.*/Illegal file pattern: Unclosed group near index xxx/
--
-- m/DETAIL/
-- s/DETAIL/CONTEXT/
--
